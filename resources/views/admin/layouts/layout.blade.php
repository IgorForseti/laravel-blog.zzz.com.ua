...
<script src="{{ asset('assets/admin/ckefinder/ckfinder.js') }}"></script>
<script type="text/javascript">
    ClassicEditor
        .create( document.querySelector( '#content' ), {
            ...
            toolbar: {
                items: [
                    'heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', '|', 'indent', 'outdent',
                    '|', 'blockQuote', 'insertTable', 'undo', 'redo', 'CKFinder', 'mediaEmbed'
                ]
            },
        } )
